...
class OlBingMapsLayer(WebLayer3857):
    ...
    def __init__(self, name, html):
        WebLayer3857.__init__(self, groupName="Bing Maps",
                              groupIcon="bing_icon.png", name=name, html=html)
...
class OlBingAerialLayer(OlBingMapsLayer):
    ...
    def __init__(self):
        OlBingMapsLayer.__init__(self, name='Bing Aerial',
                                 html='bing_aerial.html')


class OlBingAerialLabelledLayer(OlBingMapsLayer):

    def __init__(self):
        OlBingMapsLayer.__init__(self, name='Bing Aerial with labels',
                                 html='bing_aerial-labels.html')
